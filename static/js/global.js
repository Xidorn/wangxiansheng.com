...
function formatDomainDuration(duration, kind) {
    ...
    const yearIncluded = normalizedValue.includes('Y');
    const monthIncluded = normalizedValue.includes('Mo');
